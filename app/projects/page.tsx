...
export default function ProjectsPage() {
  ...
  const projectData: Project[] = [
      new Project(
        ...
        /* isDarkMode ? "/projects/Portfolio_dark.svg" :  */ "/projects/Portfolio_light.svg",
        new Date("12.05.2024"),
      ...
      new Project(
        ...
        "Here should be a longer text displayed on the project details page.",
        /* isDarkMode ? "/projects/Sonar_dark.svg" :  */ "/projects/Sonar_light.svg",
        new Date("01.08.2024"),
      ...
      new Project(
        ...
        "Here should be a longer text displayed on the project details page.",
        /* isDarkMode ? "/projects/Freelytics_dark.svg" :  */ "/projects/Freelytics_light.svg",
        new Date("01.09.2024"),
        ProjectStatus.IN_PROGRESS,
        [
          new Technology(
