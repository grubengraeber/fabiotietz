...
import TechnologySkillBaseMobile from '../../base/technology/technology-skill-base-mobile'
import TechnologySkill from '../../data/TechnologySkill'

function BackendSkillsMobile() {
  ...
  return (
    <div>
      {/* <SkillSubBase title='Backend Technologies' items={backendTechnologies} /> */}
        <TechnologySkillBaseMobile label='Backend Technology' items={backendTechnologies} />
    </div>
  )
}

export default BackendSkillsMobile
